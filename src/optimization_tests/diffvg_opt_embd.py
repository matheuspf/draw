...
def optimize_diffvg(
    ...
    for iter_idx in range(num_iterations):
        ...
        ocr_loss = score_gradient_ocr_2(vqa_evaluator, img, text="", response=target_text, prefix="<image>Describe the image in detail\n").mean()
        loss = ocr_loss
        ...
        if iter_idx == 0 or (iter_idx + 1) % validation_steps == 0:
            ...
            val_loss = vqa_score_original(vqa_evaluator, pil_image, questions, choices_list, answers)
