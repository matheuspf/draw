...
def optimize(
    ...
    for iter_idx in range(num_iterations):
        ...
        img = apply_jpeg_compression_torch(img, quality=90)
        ...
        if iter_idx == 0 or (iter_idx + 1) % validation_steps == 0:
            ...
            pil_image = torch_to_pil(img_org)
            ...
            # )
            pil_image = ImageProcessor(pil_image).apply_jpeg_compression(quality=90).image
