...
get_ipython().system('cp /tmp/kaggle-evaluation-submission-1x7qy_9i.csv pred.csv')
...
for svg, score in zip(pred_df["svg"], res[1]):
    img = svg_to_png(svg)
    print(score)
    display(img)
...
# 0.9788541396657462 0.44887804985046387 1.0
# 0.9992911409414297 0.5262135982513427 1.0
# 0.9556547673838713 0.5060272693634034 1.0
# 0.999303442069917 0.498891544342041 1.0
# 0.742068245277622 0.5067996501922607 1.0
# 0.7497945557920987 0.47991604804992677 1.0
# 0.5058674944383651 0.536838436126709 1.0
# 0.6923734742248387 0.5035767555236816 1.0
# 0.2527534065579065 0.4703400135040283 1.0
# 0.5642814340526361 0.49358015060424804 1.0
# 0.7307911568845143 0.5075275897979736 1.0
# 0.7864709433990255 0.4650264263153076 1.0
# 0.8841048249173032 0.5729361057281495 1.0
# 0.6841962972453492 0.40873894691467283 1.0
# 0.5747081741566964 0.5015057563781739 1.0
# 0.6626710276039725
